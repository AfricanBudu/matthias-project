...
const Matthias = () => {
  return (
    <div>
        <div className="flex flex-col gap-14 pl-14 md:pl-12  xs:pl-4 md:mt-28 xs:mt-8 mb-10 justify-normal items-start md:flex-row">
            <div>
                <div className="pb-10">
                <p className=" xl:text-[5.5rem] md:text-[25px] xs:text-[32px] font-Medium_Grotesk md:leading-[6.2rem] text-[#DDDAC2]">Matthias Pliessing</p>
                ...
                He uses &ldquo;kinetically contemporary&ldquo; style to craft masterpiece furniture for executive interior
                </p>
            </div>
            <div className="flex gap-4 font-General_Sans font-medium md:self-end">
                <button className=' bg-[#E8E8E8]  text-[#051118] px-6 py-1 rounded-3xl flex items-center  md:h-[50px] xs:h-[35px] md:text-[20px] xs:text-[12px]'>
                    Instagram
                </button>
                <button className=' bg-transparent  md:h-[50px] xs:h-[35px] md:text-[20px] xs:text-[12px] text-[#E8E8E8] px-6 py-1 border-[1px] border-[#E8E8E8] rounded-3xl flex items-center '>
                    Contact Us 
